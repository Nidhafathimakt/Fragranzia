...
function Footer() {
  ...
  <div className="block md:hidden">
    ...
    <div className="px-6 py-10 mt-10 flex flex-col gap-10">
      <h2 className="font-bold text-3xl text-center">Fragranzia</h2>

      <div>
        <h6 className="text-xl font-semibold">Pages</h6>
        <div className="mt-6 leading-7">
          <p className="cursor-pointer" onClick={handleHome}>Home</p>
          <p className="cursor-pointer" onClick={handleProduct}>Products</p>
          <p className="cursor-pointer">Gifting</p>
          <p className="cursor-pointer" onClick={handleAbout}>About</p>
          <p className="cursor-pointer" onClick={handleAccount}>Profile</p>
        </div>
      </div>
      ...
      <div>
        <p className="flex gap-3"><BiEnvelope /> tfrarfurniture@gmail.com</p>
        <p className="flex gap-3 mt-1"><LuPhone /> +91 9876543210</p>
    ...
    <div className="px-6 py-3 flex flex-col text-center gap-3">
      ...
      <p className="text-sm">© 2024 fragranzia Company. All rights reserved.</p>
    </div>
  </div>
  ...
  <div className="hidden md:block lg:hidden">
    ...
    <div className="px-16 py-3 text-center">
      <p>Web Accessbility | Terms of Use | Privacy Statement | Contact Us</p>
      <p className="text-sm mt-2">© 2024 fragranzia Company. All rights reserved.</p>
    </div>
  </div>
  ...
  <div className="hidden lg:block">
    ...
    <div className="px-20 py-10 mt-10 flex justify-between gap-20">
      <h2 className="font-bold text-3xl mt-10">Fragranzia</h2>
