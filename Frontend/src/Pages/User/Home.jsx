...
function Home() {
  const { goToDetails, allProduct } = useContext(ShopContext);
  ...
  return (
    <>
      ...
      <div className="featured mt-15 px-20">
        <div className="Collection flex flex-col md:flex-row gap-3 justify-between">
          ...
          <div className="flex gap-2">
            <button
              ...
              onClick={() => scrollProducts(featuredScrollRef, -1)}
              className="border border-gray-300 w-[35px] h-[35px] rounded-full shadow-lg bg-white flex items-center justify-center cursor-pointer hover:bg-gray-50"
            >
        ...
        <ScrollProduct ref={featuredScrollRef} />
      </div>
        ...
        <div className="flex flex-wrap mt-5 gap-6 justify-center">
          {(allProduct || []).slice(3, 9).map((item) => (
            <div key={item._id}>
              ...
              <p className="text-center font-semibold mt-3">{item.text}</p>
            </div>
          ))}
        </div>
      </div>
      ...
      <div className="mt-35 px-20">
        <div className="Collection flex flex-col justify-between md:flex-row gap-3">
          ...
          <div className="flex gap-2">
            <button
              ...
              onClick={() => scrollProducts(offersScrollRef, -1)}
              className="border border-gray-300 w-[35px] h-[35px] rounded-full shadow-lg bg-white flex items-center justify-center cursor-pointer hover:bg-gray-50"
            >
              <FaLessThan size={14} className="text-gray-700" />
            </button>
        ...
        <ScrollProduct ref={offersScrollRef} />
      </div>
